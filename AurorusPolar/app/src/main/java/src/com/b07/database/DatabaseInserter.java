...
public class DatabaseInserter {
  ...
  //Phase 3 add ons
  protected static int insertSerializedUser(String name, int age, String address,
      Connection connection) {
    int id = insertUser(name, age, address, connection);
    return id;
  }
  
  protected static boolean insertUnhashedPassword(String password, int userId,
      Connection connection) {
    String sql = "INSERT INTO USERPW(USERID, PASSWORD) VALUES(?,?);";
    try {
      PreparedStatement preparedStatement = connection.prepareStatement(sql);
